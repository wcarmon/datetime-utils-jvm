            ...
            pom {
                ...
                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/datetime-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/datetime-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/datetime-utils-jvm.git"
                    url = "https://github.com/wcarmon/datetime-utils-jvm/tree/main"
                }
            }
        }
